...
<img src=".\image-20220530155248238.png" alt="image-20220530155248238" style="zoom:50%;" />

当我们通过前面的：类的加载 --> 验证 --> 准备 --> 解析 --> 初始化，这几个阶段完成后，就会用到执行引擎对我们的类进行使用，同时执行引擎将会使用到我们运行时数据区

![image-20220530155206107](.\image-20220530155206107.png)

类比一下也就是大厨做饭，我们把大厨后面的东西（切好的菜，刀，调料），比作是运行时数据区。而厨师可以类比于执行引擎，将通过准备的东西进行制作成精美的菜品。

<img src=".\image-20220530155350871.png" alt="image-20220530155350871" style="zoom:50%;" />
...
<img src=".\image-20220530155739989.png" alt="image-20220530155739989" style="zoom:50%;" />
...
<img src=".\image-20220530160222062.png" alt="image-20220530160222062" style="zoom:50%;" />

### Runtime类

**每个JVM只有一个Runtime实例**。即为运行时环境，相当于内存结构的中间的那个框框：运行时环境。

![image-20220530160622326](.\image-20220530160622326.png)
...
<img src=".\image-20220530163441891.png" alt="image-20220530163441891" style="zoom:50%;" />
...
<img src=".\image-20220530163741516.png" alt="image-20220530163741516" style="zoom:50%;" />
...
```java
PS E:\Project\workspace\workspace_study_idea\litchi_jvm\out\production\chapter04\com\litchi\java> javap -v .\PCRegisterTest.class
Classfile /E:/Project/workspace/workspace_study_idea/litchi_jvm/out/production/chapter04/com/litchi/java/PCRegisterTest.class
  Last modified 2022年5月30日; size 673 bytes
  SHA-256 checksum 076a99efb79cf3fdbcb615952c1d9a92f78c2d6da66240829cf6422cac0ae264
  Compiled from "PCRegisterTest.java"
public class com.litchi.java.PCRegisterTest
  minor version: 0
  major version: 52
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #5                          // com/litchi/java/PCRegisterTest
...
Constant pool:
   ...
   #5 = Class              #32            // com/litchi/java/PCRegisterTest
  ...
  #12 = Utf8               this
  #13 = Utf8               Lcom/litchi/java/PCRegisterTest;
  #14 = Utf8               main
  ...
  #32 = Utf8               com/litchi/java/PCRegisterTest
  ...
  #39 = Utf8               (I)V
{
  public com.litchi.java.PCRegisterTest();
    descriptor: ()V
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       5     0  this   Lcom/litchi/java/PCRegisterTest;
...
<img src=".\image-20220530165655736.png" alt="image-20220530165655736" style="zoom:50%;" />
...
<img src=".\image-20220530165936339.png" alt="image-20220530165936339" style="zoom:50%;" />
...
<img src=".\image-20220530170518619.png" alt="image-20220530170518619" style="zoom:50%;" />

# 本地方法接口

## 本地方法

<img src=".\image-20220602215606556.png" alt="image-20220602215606556" style="zoom:50%;" />

1. 简单地讲，**一个Native Method是一个Java调用非Java代码的接囗**一个Native Method是这样一个Java方法：该方法的实现由非Java语言实现，比如C。这个特征并非Java所特有，很多其它的编程语言都有这一机制，比如在C++中，你可以用extern “C”告知C++编译器去调用一个C的函数。
...
<img src=".\image-20220602222518482.png" alt="image-20220602222518482" style="zoom:50%;" />
