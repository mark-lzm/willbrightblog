...
![image-20220606213410406](.\image-20220606213410406.png)
...
![image-20220606213659246](.\image-20220606213659246.png)
...
![image-20220606214923499](.\image-20220606214923499.png)
...
简单的程序，加载了1600多个类
![image-20220606215941532](.\image-20220606215941532.png)
...
![image-20220606221457764](.\image-20220606221457764.png)

![image-20220606221303569](.\image-20220606221303569.png)
...
![image-20220607110034957](.\image-20220607110034957.png)
...
![image-20220607113700436](.\image-20220607113700436.png)
...
![image-20220607114458798](.\image-20220607114458798.png)
...
![image-20220607140716751](.\image-20220607140716751.png)

2、首先将操作数500压入操作数栈中

![image-20220607140858910](.\image-20220607140858910.png)

3、然后操作数 500 从操作数栈中取出，存储到局部变量表中索引为 1 的位置

![image-20220607141013802](.\image-20220607141013802.png)

4、将操作数100压入操作数栈中

![image-20220607141134335](.\image-20220607141134335.png)

5、然后操作数 100 从操作数栈中取出，存储到局部变量表中索引为 2 的位置

![image-20220607141324249](.\image-20220607141324249.png)

6、从本地变量表中取索引为1的数据，压入操作数栈

![image-20220607141416768](.\image-20220607141416768.png)

7、从本地变量表中取索引为2的数据，压入操作数栈

![image-20220607141535782](.\image-20220607141535782.png)

8、将栈顶两int类型数相除，结果入栈，并且用 istore_3,将操作数5 存储到索引为3的本地变量表中

![image-20220607141724383](.\image-20220607141724383.png)

9、将操作数50入操作数栈

![image-20220607141838337](.\image-20220607141838337.png)

10、getstatic，获取类或接口字段的值，并将其推入操作数栈（注：图片写错了，应为#25，#26）

![image-20220607142257497](.\image-20220607142257497.png)

11、

![image-20220607142531995](.\image-20220607142531995.png)

12、

![image-20220607142629084](.\image-20220607142629084.png)

13、add

![image-20220607142658706](.\image-20220607142658706.png)

14、

![image-20220607142732219](.\image-20220607142732219.png)

15、

![image-20220607142944014](.\image-20220607142944014.png)
...
![image-20220607143711515](.\image-20220607143711515.png)
...
![image-20220607152334462](.\image-20220607152334462.png)

JDK7环境下，放在PSOldGen（老年代）中

![image-20220607152115296](.\image-20220607152115296.png)

JDK8环境下，放在PSOldGen（老年代）中

![image-20220607152452320](.\image-20220607152452320.png)
...
![image-20220608093407708](.\image-20220608093407708.png)
...
![image-20220608093717903](.\image-20220608093717903.png)

**直接缓冲区（NIO）**

NIO 直接操作物理磁盘，省去了中间过程

![image-20220608093855270](.\image-20220608093855270.png)
...
![image-20220608095817654](.\image-20220608095817654.png)
