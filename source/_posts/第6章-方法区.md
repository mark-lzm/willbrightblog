...
<img src=".\image-20220606213410406.png" alt="image-20220606213410406" style="zoom:67%;" />
...
<img src=".\image-20220606213659246.png" alt="image-20220606213659246" style="zoom:50%;" />
...
<img src=".\image-20220606214923499.png" alt="image-20220606214923499" style="zoom:67%;" />
...
<img src=".\image-20220606215941532.png" alt="image-20220606215941532" style="zoom:50%;" />
...
<img src=".\image-20220606221457764.png" alt="image-20220606221457764" style="zoom:67%;" />

<img src=".\image-20220606221303569.png" alt="image-20220606221303569" style="zoom:50%;" />
...
![image-20220606223118367](.\image-20220606223118367.png)
...
<img src=".\image-20220607110034957.png" alt="image-20220607110034957" style="zoom:50%;" />

《深入理解Java虚拟机》书中对方法区（Method Area）存储内容描述如下：它用于存储已被虚拟机加载的**类型信息、常量、静态变量、即时编译器编译后的代码缓存**等。

![image-20220607110220031](.\image-20220607110220031.png)
...
```java
Classfile /E:/Project/workspace/workspace_study_idea/litchi_jvm/out/production/chapter09/com/litchi/java/MethodInnerStrucTest.class
  Last modified 2022年6月7日; size 1624 bytes
  SHA-256 checksum 120df50ffbc665ed3f9d72f5d714c078bde28b7928d4b6aef6779e8bd56e2b26
  Compiled from "MethodInnerStrucTest.java"
//类型信息
public class com.litchi.java.MethodInnerStrucTest extends java.lang.Object implements java.lang.Comparable<java.lang.String>, java.io.Serializable
  minor version: 0
  major version: 52
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #17                         // com/litchi/java/MethodInnerStrucTest
  super_class: #18                        // java/lang/Object
  interfaces: 2, fields: 2, methods: 6, attributes: 2
Constant pool:
   #1 = Methodref          #18.#52        // java/lang/Object."<init>":()V
   #2 = Fieldref           #17.#53        // com/litchi/java/MethodInnerStrucTest.num:I
  ...
  #14 = Methodref          #17.#66        // com/litchi/java/MethodInnerStrucTest.compareTo:(Ljava/lang/String;)I
  #15 = String             #67            // 测试方法的内部结构
  #16 = Fieldref           #17.#68        // com/litchi/java/MethodInnerStrucTest.str:Ljava/lang/String;
  #17 = Class              #69            // com/litchi/java/MethodInnerStrucTest
  ...
  #30 = Utf8               this
  #31 = Utf8               Lcom/litchi/java/MethodInnerStrucTest;
  #32 = Utf8               test1
  #33 = Utf8               count
  #34 = Utf8               test2
  #35 = Utf8               (I)I
  ...
  #69 = Utf8               com/litchi/java/MethodInnerStrucTest
  ...
  #84 = Utf8               printStackTrace
{
  ...
  //方法信息
  public com.litchi.java.MethodInnerStrucTest();
    descriptor: ()V
    flags: (0x0001) ACC_PUBLIC
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      11     0  this   Lcom/litchi/java/MethodInnerStrucTest;
  ...
  public void test1();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      29     0  this   Lcom/litchi/java/MethodInnerStrucTest;
            3      26     1 count   I
  ...
  public int compareTo(java.lang.String);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       2     0  this   Lcom/litchi/java/MethodInnerStrucTest;
  ...
  public int compareTo(java.lang.Object);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       9     0  this   Lcom/litchi/java/MethodInnerStrucTest;
...
<img src=".\image-20220607113700436.png" alt="image-20220607113700436" style="zoom:50%;" />
...
1. 一个有效的字节码文件中除了包含类的版本信息、字段、方法以及接口等描述符信息外。还包含一项信息就是**常量池表**（**Constant Pool Table**），包括各种**字面量**和对类型、域和方法的**符号引用**。
2. 字面量： 10 ， “我是某某”这种数字和字符串都是字面量

<img src=".\image-20220607114458798.png" alt="image-20220607114458798" style="zoom:50%;" />
...
![image-20220607114720082](.\image-20220607114720082.png)
...
```java
Classfile /E:/Project/workspace/workspace_study_idea/litchi_jvm/out/production/chapter09/com/litchi/java/MethodAreaDemo.class
  Last modified 2022年6月7日; size 636 bytes
  SHA-256 checksum 04c96932cca9bf7761e015dbc70f4e4698565c5e165bab0ef56ca445c58dcac0
  Compiled from "MethodAreaDemo.java"
public class com.litchi.java.MethodAreaDemo
  minor version: 0
  major version: 52
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #4                          // com/litchi/java/MethodAreaDemo
...
Constant pool:
   ...
   #4 = Class              #29            // com/litchi/java/MethodAreaDemo
  ...
  #11 = Utf8               this
  #12 = Utf8               Lcom/litchi/java/MethodAreaDemo;
  #13 = Utf8               main
  ...
  #29 = Utf8               com/litchi/java/MethodAreaDemo
  ...
  #36 = Utf8               (I)V
{
  public com.litchi.java.MethodAreaDemo();
    descriptor: ()V
    flags: (0x0001) ACC_PUBLIC
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       5     0  this   Lcom/litchi/java/MethodAreaDemo;
...
<img src=".\image-20220607140716751.png" alt="image-20220607140716751" style="zoom:40%;" />

2、首先将操作数500压入操作数栈中

<img src=".\image-20220607140858910.png" alt="image-20220607140858910" style="zoom:40%;" />

3、然后操作数 500 从操作数栈中取出，存储到局部变量表中索引为 1 的位置

<img src=".\image-20220607141013802.png" alt="image-20220607141013802" style="zoom:40%;" />

4、将操作数100压入操作数栈中

<img src=".\image-20220607141134335.png" alt="image-20220607141134335" style="zoom:40%;" />

5、然后操作数 100 从操作数栈中取出，存储到局部变量表中索引为 2 的位置

<img src=".\image-20220607141324249.png" alt="image-20220607141324249" style="zoom:40%;" />

6、从本地变量表中取索引为1的数据，压入操作数栈

<img src=".\image-20220607141416768.png" alt="image-20220607141416768" style="zoom:40%;" />

7、从本地变量表中取索引为2的数据，压入操作数栈

<img src=".\image-20220607141535782.png" alt="image-20220607141535782" style="zoom:40%;" />

8、将栈顶两int类型数相除，结果入栈，并且用 istore_3,将操作数5 存储到索引为3的本地变量表中

<img src=".\image-20220607141724383.png" alt="image-20220607141724383" style="zoom:40%;" />

9、将操作数50入操作数栈

<img src=".\image-20220607141838337.png" alt="image-20220607141838337" style="zoom:40%;" />

10、getstatic，获取类或接口字段的值，并将其推入操作数栈（注：图片写错了，应为#25，#26）

<img src=".\image-20220607142257497.png" alt="image-20220607142257497" style="zoom:40%;" />

11、

<img src=".\image-20220607142531995.png" alt="image-20220607142531995" style="zoom:40%;" />

12、

<img src=".\image-20220607142629084.png" alt="image-20220607142629084" style="zoom:40%;" />

13、add

<img src=".\image-20220607142658706.png" alt="image-20220607142658706" style="zoom:40%;" />

14、

<img src=".\image-20220607142732219.png" alt="image-20220607142732219" style="zoom:40%;" />

15、

<img src=".\image-20220607142944014.png" alt="image-20220607142944014" style="zoom:40%;" />
...
<img src=".\image-20220607143711515.png" alt="image-20220607143711515" style="zoom:50%;" />

**JDK7**

方法区由永久代实现，使用 JVM 虚拟机内存

![image-20220607143826040](.\image-20220607143826040.png )

**JDK8**

方法区由元空间实现，使用物理机本地内存

![image-20220607143938936](.\image-20220607143938936.png)
...
JDK6环境下，放在PSOldGen（老年代）中

<img src=".\image-20220607152334462.png" alt="image-20220607152334462" style="zoom:67%;" />

JDK7环境下，放在PSOldGen（老年代）中

<img src=".\image-20220607152115296.png" alt="image-20220607152115296" style="zoom:67%;" />

JDK8环境下，放在PSOldGen（老年代）中

<img src=".\image-20220607152452320.png" alt="image-20220607152452320" style="zoom:67%;" />
...
![image-20220607153156415](.\image-20220607153156415.png)
...
![image-20220607153400076](.\image-20220607153400076.png)
...
4. 先来说说方法区内常量池之中主要存放的两大类常量：<u>字面量</u>和<u>符号引用</u>。字面量比较接近Java语言层次的常量概念，如文本字符串、被声明为final的常量值等。而符号引用则属于编译原理方面的概念，包括下面三类常量：
   - 类和接口的全限定名
   - 字段的名称和描述符
   - 方法的名称和描述符
...
![image-20220607154848903](.\image-20220607154848903.png)
...
<img src=".\image-20220608093407708.png" alt="image-20220608093407708" style="zoom:50%;" />
...
<img src=".\image-20220608093717903.png" alt="image-20220608093717903" style="zoom:50%;" />

**直接缓冲区（NIO）**

NIO 直接操作物理磁盘，省去了中间过程

<img src=".\image-20220608093855270.png" alt="image-20220608093855270" style="zoom:50%;" />
...
Exception in thread "main" java.lang.OutOfMemoryError: Direct buffer memory
	...
	at com.litchi.java.BufferTest2.main(BufferTest2.java:19)
```

<img src=".\image-20220608095817654.png" alt="image-20220608095817654" style="zoom:50%;" />
