...
2. 代码举例
   ...
   **举例1：**
   ...
   查看字节码文件，`Integer x = 5;`调用了Integer.valueOf方法
...
用描述符来描述方法时，按照先参数列表，后返回值的顺序描述，参数列表按照参数的严格顺序放在一组小括号“()”之内。如方法java.lang.String toString()的描述符为()Ljava/lang/String;，方法int abc(int[] ×,int y)的描述符为([II) I。
