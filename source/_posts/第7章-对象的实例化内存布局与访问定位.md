---
title: 第7章-对象的实例化内存布局与访问定位
date: 2022-10-24 10:54:19
categories:
- [JVM, 1.内存与垃圾回收篇章]
tags:
- JVM
...
<img src=".\image-20220607213742139.png" alt="image-20220607213742139" style="zoom:50%;" />
...
![image-20220607222632565](.\image-20220607222632565.png)
...
![image-20220607223152848](.\image-20220607223152848.png)

## 对象的访问定位

**JVM是如何通过栈帧中的对象引用访问到其内部的对象实例呢？**

![image-20220607223600023](.\image-20220607223600023.png)
...
<img src=".\image-20220607223802345.png" alt="image-20220607223802345" style="zoom:50%;" />
...
![image-20220607223840168](.\image-20220607223840168.png)